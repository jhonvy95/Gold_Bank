	...
	<div id="Historial">
		<div class="container">
			...
			<h2>
				Último Movimiento:
				<span>
					{{ accountByUsername.lastChance.substring(0, 10) }}
					{{ accountByUsername.lastChance.substring(11, 19) }}
				</span>
			</h2>
		</div>
...
<style>
	...
	#Historial table th {
		...
		padding-bottom: 12px;
		text-align: left;
		background-color: rgb(177, 159, 3);
		color: #383838;
	}
	...
	#Historial .container {
		padding: 30px;
		border: 3px solid rgba(195, 152, 8, 0.3);
		border-radius: 20px;
		margin: 5% 0 1% 0;
